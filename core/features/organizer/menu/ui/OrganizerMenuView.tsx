...
import { useOrganizerMenu } from './hooks/useOrganizerMenu'

export type OrganizerMenuViewProps = {
  onCancel: () => void
  onReturnToRaceList: () => void
}

export const OrganizerMenuView = ({
  onCancel,
  onReturnToRaceList,
}: OrganizerMenuViewProps) => {
  const menu = useOrganizerMenu()
