  ...
  if (joinRequests.acceptedRequest) {
    return (
      <>
        <section className="flex min-h-[calc(100svh-137px)] flex-col justify-between px-6 pb-5 pt-7">
          ...
          <div className="space-y-3">
            ...
            <button
              ...
              onClick={joinRequests.openCancelConfirmation}
            >
              Hủy
            </button>
          </div>
        ...
        <Modal
          open={joinRequests.isCancelConfirmationOpen}
          title="Hủy lượt chơi?"
          onClose={joinRequests.dismissCancelConfirmation}
          footer={(
            <>
              <Button
                variant="secondary"
                disabled={joinRequests.isCancelling}
                onClick={joinRequests.dismissCancelConfirmation}
              >
                Quay lại
              </Button>
              <Button
              ...
              >
                {joinRequests.isCancelling ? 'Đang hủy...' : 'Hủy lượt chơi'}
              </Button>
            </>
          )}
        >
          <p className="text-sm leading-6 text-[#525252]">
            Đội {joinRequests.acceptedRequest.teamName} sẽ bị đưa khỏi trạm và có thể chọn trạm khác.
          </p>
        </Modal>
      </>
    )
