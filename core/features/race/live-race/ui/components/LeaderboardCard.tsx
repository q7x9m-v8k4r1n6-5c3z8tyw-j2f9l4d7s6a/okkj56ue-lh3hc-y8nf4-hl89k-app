...
import { useLeaderboardSection } from '../hooks/useLeaderboardSection'
import { SectionHeader } from './SectionHeader'

export const LeaderboardCard = ({ raceId }: { raceId?: string }) => {
  const { items, isLoading } = useLeaderboardSection(raceId)
