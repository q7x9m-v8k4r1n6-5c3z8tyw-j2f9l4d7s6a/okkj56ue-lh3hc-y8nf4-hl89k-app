...
export const CardStoreManagementView = () => {
  ...
  return <section className="space-y-5">
    <div className="rounded-lg border border-[#e5e5e5] bg-white px-3 py-2 shadow-none"><div className="flex min-h-9 flex-wrap items-center gap-2"><Button size="sm" variant="secondary" leadingIcon={<UploadIcon className="size-5" />} onClick={() => setRestockOpen(true)}>Nhập kho</Button><span className="ml-auto text-xs text-[#737373]">Cấp card cho team trong phần chi tiết từng card.</span></div></div>
